...
export default function Terms() {
  ...
  const sections = t('static.terms.sections', { returnObjects: true }) as { title: string; content: string }[];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="mx-auto max-w-2xl px-6 py-16">
        <h1 className="text-[32px] font-bold tracking-tight mb-2">{t('static.terms.title')}</h1>
        <p className="text-[13px] text-muted-foreground mb-10">{t('static.terms.lastUpdated')}</p>
