    ...
    >
        ...
        <div className="divide-y divide-border">
          {events.map(event => (
            <button 
              ...
              className="flex items-center gap-2 w-full px-3 sm:px-3.5 py-2 sm:py-2.5 text-left hover:bg-accent/40 transition-colors group"
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[13px] sm:text-[14px] font-medium text-foreground truncate group-hover:text-primary transition-colors">
                  {event.title}
                </p>
                <div className="flex flex-wrap items-center gap-1.5 sm:gap-2.5 mt-1.5">
                  <Badge 
                    variant="outline" 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 border-t border-border">
        {[
          ...
          <div
            key={s.label}
            className="flex flex-col items-center py-3 gap-0.5 border-b sm:border-b-0 sm:border-r last:border-r-0 border-border"
          >
