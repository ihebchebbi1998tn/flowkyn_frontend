...
export function UserProfileSetup({
  ...
  subtitle = 'Pick a nickname and avatar before you join.',
  defaultName = '',
  defaultAvatarUrl,
    ...
    <div className={cn("w-full max-w-lg space-y-6", !asModal && "mx-auto")}>
      ...
      <div className={cn("rounded-2xl border border-border bg-card space-y-5", asModal ? "p-5" : "p-6")}>
        ...
        <div className="space-y-1.5">
          <Label className="text-xs font-semibold text-foreground uppercase tracking-wider">Nickname *</Label>
        ...
        <AnimatePresence>
          {(name.trim() || avatarUrl) && (
            ...
            >
              {avatarUrl ? (
                <img src={avatarUrl} alt="Your avatar" className="h-10 w-10 rounded-xl object-cover shrink-0" />
              ) : (
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground">This is how you'll appear in the game</p>
              </div>
        ...
        <div className="flex gap-2">
          ...
          >
            {isPending ? (
              ...
              <>{submitLabel} {!asModal && <ArrowRight className="h-4 w-4" />}</>
            )}
          </Button>
        </div>
      </div>
