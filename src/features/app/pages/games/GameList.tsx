      ...
      >
        ...
        <div className="relative h-44 overflow-hidden">
          ...
          <div className="absolute top-2.5 left-2.5 flex gap-1.5">
            <Badge className={cn("text-[10px] font-semibold border shadow-sm backdrop-blur-xl", categoryColors[activity.category])}>
              {t(`games.categories.${activity.category}`)}
            </Badge>
            <Badge variant="outline" className={cn(
              "text-[10px] font-semibold gap-1 shadow-md backdrop-blur-xl border",
              activity.type === 'sync'
                ? 'text-primary-foreground border-primary/40 bg-primary/80'
                : 'text-success-foreground border-success/40 bg-success/80'
            )}>
              {activity.type === 'sync'
          ...
          {activity.popular && (
            <div className="absolute top-2.5 right-2.5">
              <Badge className="bg-primary text-primary-foreground border-0 text-[10px] font-bold gap-1 shadow-sm">
