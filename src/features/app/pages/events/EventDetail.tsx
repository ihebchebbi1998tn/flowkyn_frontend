...
export default function EventDetail() {
  ...
  const lobbyUrl = (eventId: string) =>
    `${ROUTES.EVENT_LOBBY(eventId)}?activity=${gameId}`;
  ...
  const eventMode = (event as any).event_mode === 'async'
    ? t('events.async', { defaultValue: 'Async' })
    : t('events.liveSync', { defaultValue: 'Live (Sync)' });
  ...
  return (
    <div className="space-y-6 w-full animate-fade-in">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        ...
        />
        <DashStat
          label={t('events.eventMode', { defaultValue: 'Mode' })}
          value={eventMode}
          icon={Gamepad2}
          gradient="warning"
        />
          ...
          <ChartCard title={t('events.details', { defaultValue: 'Event Details' })} className="lg:col-span-1">
            <div className="space-y-3">
              {[
                ...
                { label: t('events.eventMode', { defaultValue: 'Mode' }), value: eventMode },
